# Comparing `tmp/custardpy-0.4.1-py3-none-any.whl.zip` & `tmp/custardpy-0.4.2-py3-none-any.whl.zip`
...
## Comparing `custardpy-0.4.1.data/scripts/InsulationScore.py` & `custardpy-0.4.2.data/scripts/InsulationScore.py`
