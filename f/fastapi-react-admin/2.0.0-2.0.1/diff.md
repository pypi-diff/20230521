# Comparing `tmp/fastapi_react_admin-2.0.0.tar.gz` & `tmp/fastapi_react_admin-2.0.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "fastapi_react_admin-2.0.0.tar", max compression
+gzip compressed data, was "fastapi_react_admin-2.0.1.tar", max compression
```

## Comparing `fastapi_react_admin-2.0.0.tar` & `fastapi_react_admin-2.0.1.tar`

### file list

```diff
@@ -1,7 +1,7 @@
--rw-r--r--   0        0        0       35 2023-05-17 17:29:31.844703 fastapi_react_admin-2.0.0/fastapi_react_admin/__init__.py
--rw-r--r--   0        0        0     7655 2023-05-19 07:45:43.026187 fastapi_react_admin-2.0.0/fastapi_react_admin/react_admin.py
--rw-r--r--   0        0        0      149 2023-05-18 08:55:36.202042 fastapi_react_admin-2.0.0/fastapi_react_admin/schemas.py
--rw-r--r--   0        0        0      426 2023-05-19 07:47:17.518630 fastapi_react_admin-2.0.0/pyproject.toml
--rw-r--r--   0        0        0     5045 2023-05-19 07:47:11.756747 fastapi_react_admin-2.0.0/README.md
--rw-r--r--   0        0        0     5752 1970-01-01 00:00:00.000000 fastapi_react_admin-2.0.0/setup.py
--rw-r--r--   0        0        0     5407 1970-01-01 00:00:00.000000 fastapi_react_admin-2.0.0/PKG-INFO
...
### Comparing `fastapi_react_admin-2.0.0/fastapi_react_admin/react_admin.py` & `fastapi_react_admin-2.0.1/fastapi_react_admin/react_admin.py`
...
### Comparing `fastapi_react_admin-2.0.0/README.md` & `fastapi_react_admin-2.0.1/README.md`

 * *Files identical despite different names*

### Comparing `fastapi_react_admin-2.0.0/setup.py` & `fastapi_react_admin-2.0.1/setup.py`
...
### Comparing `fastapi_react_admin-2.0.0/PKG-INFO` & `fastapi_react_admin-2.0.1/PKG-INFO`
